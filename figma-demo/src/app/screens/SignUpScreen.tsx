        ...
        <div className="flex flex-col h-full pt-8 pb-8 px-6">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <p className="text-center text-muted-foreground mb-8">
              ...
              <button className="text-[var(--vaykae-pink)]">Resend</button>
            </p>
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="flex items-start gap-2 mb-6">
            ...
            <label htmlFor="terms" className="text-sm text-muted-foreground">
              I agree to the{" "}
              <span className="text-[var(--vaykae-pink)]">Terms of Service</span>{" "}
              and <span className="text-[var(--vaykae-pink)]">Privacy Policy</span>
            </label>
          </div>
